...
\newglossaryentry{natural-language-processing}{
    ...
    description={A field of artificial intelligence focused on enabling computers to understand, interpret, and generate human language},
    see=[acronym:]{nlp}
}
...
\newglossaryentry{openai}{
    name={OpenAI},
    description={An artificial intelligence research and deployment company that develops \gls{large-language-model} systems such as \gls{chatgpt}. See \url{https://openai.com/}}
}
...
\newglossaryentry{vx-underground}{
    name={VX-Underground},
    description={A repository and research collective that archives malware samples, threat intelligence, and cybersecurity resources for educational and research purposes. See \url{https://vx-underground.org/}}
}
...
\newglossaryentry{indicator-of-compromise}{
    name={Indicator of Compromise},
    description={A forensic artifact or piece of evidence on a system or network that indicates a potential intrusion or malicious activity},
    see=[acronym:]{ioc}
}
...
\newglossaryentry{pdm}{
    name={PDM},
    description={See \gls{python-pdm}},
    see=[main entry:]{python-pdm}
}
\newglossaryentry{python-pdm}{
    name={Python PDM},
    description={A modern Python package and dependency manager that uses the PEP 582 standard for managing project dependencies and environments. See \url{https://pdm-project.org/}}
}
