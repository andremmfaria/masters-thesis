...
\begin{abstract}
	...
	Generation (RAG) can strengthen static malware analysis. We design a dual-pipeline prototype that
	contrasts a deterministic baseline—Ghidra-derived heuristics with optional VirusTotal
